...
import TrackingFormPage from './pages/tracking/TrackingFormPage'
      ...
      <BrowserRouter>
        <Toaster position="top-right" containerStyle={{ zIndex:999999 }}
          toastOptions={{ duration:3500,
            style:{ fontFamily:'Plus Jakarta Sans, sans-serif', fontSize:13, fontWeight:500, borderRadius:10, boxShadow:'0 8px 30px rgba(0,0,0,0.18)' },
            success:{ iconTheme:{ primary:'#10B981', secondary:'#fff' } },
            error:  { iconTheme:{ primary:'#B91C3C', secondary:'#fff' } },
          }}/>
        <Routes>
          {/* Pantallas completas (sin AppLayout) */}
          ...
          <Route path="/tracking/new"               element={<TrackingFormPage />} />
          <Route path="/tracking/:id/edit"          element={<TrackingFormPage />} />
