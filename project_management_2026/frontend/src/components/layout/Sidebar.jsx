...
import { LayoutDashboard, Globe, Building2, University, Layers,
         DollarSign, UserCheck, Activity, FolderOpen,
...
const navItems = [
  {
    ...
    items: [
      ...
      { to: '/tracking',  icon: ClipboardList,   label: 'Seguimiento y Control' },
      { to: '/reportes',  icon: Activity,        label: 'Reportes'              },
    ],
  },
  {
    section: 'Catálogos',
